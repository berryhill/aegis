...
- [Built-in Aegis manager](AEGIS_MANAGER.md) — explicit manager UX, root dispatch boundary, secure prompt boundary, protected credential intake, local Ollama lifecycle, and implementation completion gates.
