...
func NewRegistry() (*Registry, error) {
	...
	definitions := []Definition{
		...
		{Name: "agents", Usage: "/agents readiness | list | show <agent-id> [revision] | prepare <charter-file> <fixture-file> <fleet-id> <source-id> | register <charter-file> <fixture-file> <fleet-id> <source-id> <revision-digest>", Grammar: "closed Agent Registry form", Class: WorkflowMutation, States: active, Prerequisites: []string{"authenticated manager context"}, Scopes: []string{"agent-registry"}, Consequence: Mutation, Policy: "manager.agents", Audit: "manager.agents", ResultSchema: "agents.v1", Help: "Inspect readiness and perform exact preview-confirmed Agent registration with authoritative readback.", Base: false},
