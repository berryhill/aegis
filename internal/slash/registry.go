...
func NewRegistry() (*Registry, error) {
	...
	definitions := []Definition{
		...
		{Name: "agents", Usage: "/agents readiness | list | show <agent-id> [revision] | import hermes default [confirm <revision-digest>] | prepare <charter-file> <fixture-file> <fleet-id> <source-id> | register <charter-file> <fixture-file> <fleet-id> <source-id> <revision-digest>", Grammar: "closed Agent Registry form", Class: WorkflowMutation, States: active, Prerequisites: []string{"authenticated manager context"}, Scopes: []string{"agent-registry"}, Consequence: Mutation, Policy: "manager.agents", Audit: "manager.agents", ResultSchema: "agents.v1", Help: "Deterministic Agent Registry readiness and exact reads. Import the owner-verified local Hermes default profile with preview and exact confirmation; provenance never grants authority or activates execution.", Base: false, Discoverable: true},
