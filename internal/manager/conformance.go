...
func ConformanceCorpus() []ConformanceCase {
	return []ConformanceCase{
		...
		{ID: "create-protected", Requirement: "propose typed create without a value", Input: "Use exactly secret.propose_create with reference api-token, kind opaque, and disclosure none, returning only that proposal and its allowed arguments.", ExpectedKind: "proposal", ExpectedOperation: SecretProposeCreate},
