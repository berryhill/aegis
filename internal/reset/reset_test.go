...
func TestCompleteResetAndFirstRunReplay(t *testing.T) {
	...
	paths := []string{
		...
		filepath.Join(f.state, "manager", "certifications", "candidate.json.checkpoint"),
		filepath.Join(f.state, "manager", "certifications", "candidate.json.checkpoint.lock"),
		filepath.Join(f.state, "manager", "certifications", "candidate.json.checkpoint.expired.123456"),
