...
8. `hermes skills inspect berryhill/aegis/skills/aegis-session-operations` previews the session-operations skill without installation.
...
14. `hermes skills install berryhill/aegis/skills/aegis-session-operations --yes` installs the direct repository session-operations skill.
